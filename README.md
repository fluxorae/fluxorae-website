...
The Fluxorae website project includes a comprehensive testing setup using Jest and React Testing Library. This ensures component quality and reliability.
...
- **[jest.config.js](jest.config.js)** - Jest configuration with Next.js support
- **[jest.setup.js](jest.setup.js)** - Global test setup file with testing utilities

## Test Files

Sample tests are provided for critical components:
- [components/layout/Header.test.tsx](components/layout/Header.test.tsx) - Navigation component tests
- [components/contact/ContactForm.test.tsx](components/contact/ContactForm.test.tsx) - Form component tests
- [components/common/CTA.test.tsx](components/common/CTA.test.tsx) - Button component tests
...
For detailed guidance on writing tests, testing patterns, and best practices, refer to [TESTING.md](TESTING.md).
