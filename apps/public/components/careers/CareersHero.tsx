      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <h1 className="heading-1 text-white mb-6 text-balance">
            Build Your Career with Fluxorae
          </h1>
          <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto text-balance mb-10">
            Join a global team of innovators, creators, and problem-solvers. Build your career with us and make an impact.
          </p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
